function [seismos,ind] = group_select(group);
...
%                group vector - deprecated for now
%
...
seismo_struct = struct(...
    'Cleveland_17',{{'NIKH','OKAK','OKTU','OKER','OKID','MSOM','MGOD','MCIR',...
                    'MREP','MSW','MTBL','UNV','KOFP','KOKL','KOWE','ATKA'}},...  % LVA?
    'Cleveland_30',{{'OKWR','OKWE','OKTU','OKRE','OKER','KOFP','KONW','KOKL','KOWE','ATKA'}},...
    'Redoubt_2',{{'RDT','BKG','CKL','CKN','SPWE','SPBG','BGL','CP2',...
                'CRP','SPNW','NCG','STLK','SSN'}}...
    );

seismos = eval(['seismo_struct.' group]);

% Alternates
%     'Redoubt_2',{{'RDT','RDJH','BKG','CKL','CKN','SPWE','SPBG','BGL','CP2',...
%                 'CRP','SPNW','NCG','STLK','SSN','FIB','RC01','SKN','SWD',...
%                 'FOSS','KVT','KAKN','KCG','KCE','TRF','CHUM','RND','EYAK',...
%                 'DHY','GOAT','BMR','PAX','WASW','BERG','SUCK','TRAP'}}...
