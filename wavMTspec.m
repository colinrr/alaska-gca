function[W] = wavMTspec(W,wlen,foverlap,nw,nfft,tlims,fband,plotflag,maxrows)
% [W] = wavMTspec(W,wlen,foverlap,nw,nfft,tlims,fband,plotflag,maxrows)
% Generate multitaper spectrograms from GISMO waveform object. Uses pmtm
% defaults for the most part
% INPUT:    w    = GISMO waveform
...
%
% OUTPUT:   w2  = modified waveform object with added fields:
...
%     f        = linspace(0,freq/2,fix(nfft/2)+1); % Build freq vector, hope it works
    [din, t] = getSTFTColumns(d,nd,wlen,wlen-nover,freq);
